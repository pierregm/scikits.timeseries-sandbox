...
//    PyObject* (*getdateparam)(DateObject*, void*) = NULL;
...
//                   result = getdateparam(curr_date, NULL);
...
//                   Py_DECREF(curr_date);
            ...
            PyArray_SETITEM(newArray, iterResult->dataptr, result);
