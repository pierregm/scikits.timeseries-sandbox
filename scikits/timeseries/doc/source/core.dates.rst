...
.. htmlonly::
   ...
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.qyear         | Quarter Year (1)                 |   ...   |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.quarter       | Quarter                          | [1-4]   |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.month         | Month                            | [1-12]  |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.week          | Week number                      | [1-53]  |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.day           | Day of the month                 | [1-31]  |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.day_of_week   | Day of the week, starting Monday | [0-6]   |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.weekday       |                                  |         |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.day_of_year   | Day of the year, starting Jan-01 | [1-366] |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.hour          | Hour                             | [00-23] |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.minute        | Minute                           | [00-59] |
   +-----------------------------------+----------------------------------+---------+
   | .. attribute:: Date.second        | Seconds                          | [00-59] |
   +-----------------------------------+----------------------------------+---------+
