...
financial and economic data of daily (Monday-Friday) and monthly frequencies and
compare data series of differing frequencies. This led to the creation of
a large number of frequency conversion algorithms (implemented in C for extra
